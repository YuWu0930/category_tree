...
function Categories({category, deleteNodeFromRoot, categories, setCategories}) {
    ...
    const EditSubmit = ()=> {
      ...
      const updateTitle = [...categories]
      updateTitle[index] = {...updateTitle[index], title:title}
      setCategories(updateTitle)
      setEditMode(false)
  ...
  return (
    <NodeContainer>
      <ChildrenContainer>
        ...
        <ButtonContainer>
          {editMode ? (
            <EditButton onClick={EditSubmit}>Save</EditButton>
          ) : (
